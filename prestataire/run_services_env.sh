...
## Run ./run_service_env.sh sncf dev to start all services in local sncf environment 

## Run ./run_service_env.sh sncf prod to start all services in production sncf environment
...
if [[ $1 = "sncf" && $2 = "dev" ]] || [[ $2 = "sncf" && $1 = "dev" ]] || [[ $1 = "plmcf" && $2 = "dev" ]] || [[ $2 = "plmcf" && $1 = "dev" ]]
then
